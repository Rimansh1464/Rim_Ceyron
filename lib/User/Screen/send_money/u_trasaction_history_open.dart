...
class UserTransactionView extends StatefulWidget {

   var transactionMode;
  TransactionsData Data;

  UserTransactionView({super.key,
  ...
  @override
  State<UserTransactionView> createState() => _UserTransactionViewState();
}

class _UserTransactionViewState extends State<UserTransactionView> {
  ...
  Widget build(BuildContext context) {
    ...
    // double adminCharge = (widget.Data.amount * int.parse(widget.Data.adminCharge)) / 100;
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          if(widget.Data.transactionType == "user_to_user")...[
                            if(getController.isCountry.value)...[
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text("${widget.Data.amount} USD",style: TextStyle(fontSize: 18,fontWeight:FontWeight.w500),),
                                ],),
                              ...
                              Column(children: [
                                Row(
                                  ...
                                  children: [
                                    Text("${widget.Data.receiverName.split(' ')[0]} ${lang?.translate("will get")}:",style: TextStyle(fontSize: 13,color: Colors.black87,fontWeight:FontWeight.w500),),
                                    Text("${(double.parse(widget.Data.amount) * getController.currency.value).toStringAsFixed(3)} ${getController.currencyType.value}",style: TextStyle(fontSize: 16,fontWeight:FontWeight.w500),),
                                  ],),
                                Row(
                                ...
                                Row(
                                  ...
                                  children: [
                                    Text("${lang?.translate('Admin Charge')} ${widget.Data.adminCharge}%",style: TextStyle(fontSize: 11,color: Colors.grey),),
                                    Text("+ ${(double.parse(widget.Data.adminCharge) * getController.currency.value).toStringAsFixed(6)} ${getController.currencyType.value}",style: TextStyle(fontSize: 14,fontWeight:FontWeight.w400),),
                                  ],),
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.end,
                                  children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    Text("${lang?.translate('Amount will debited')} :",style: TextStyle(fontSize:13,color: Colors.black87,fontWeight:FontWeight.w500),),
                                    // Text("${totalAmount} USD",style: TextStyle(fontSize:18,fontWeight:FontWeight.w500),),
                                    Text("${(double.parse(widget.Data.finalAmount) * getController.currency.value).toStringAsFixed(6)} ${getController.currencyType.value}",style:  TextStyle(fontSize:16,fontWeight:FontWeight.w500),),
                                  ],),
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.end,
                                  children: [
                          ...
                          else if(widget.Data.transactionType == "user_to_agent")...[
                            if(getController.isCountry.value)...[
                              Column(children: [
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                ...
                                Row(
                                  ...
                                  children: [
                                    Text("${lang?.translate('Admin Charge')} ${widget.Data.adminCharge}%",style: TextStyle(fontSize: 11,color: Colors.grey),),
                                    Text("+ ${adminChargePer.toStringAsFixed(6)} USD",style: TextStyle(fontSize: 14,fontWeight:FontWeight.w400),),
                                  ],),
                                SizedBox(height: 2,),
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    ...
                                    Text("+ ${agentChargePer.toStringAsFixed(6)} USD",style: TextStyle(fontSize: 14,fontWeight:FontWeight.w400),),
                                  ],),
                                SizedBox(height: 2,),
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    Text("${lang?.translate('Amount will debited')} :",style: TextStyle(fontSize:13,color: Colors.black87,fontWeight:FontWeight.w500),),
                                    // Text("${totalAmount} USD",style: TextStyle(fontSize:18,fontWeight:FontWeight.w500),),
                                    Text("${widget.Data.debitAmount} USD",style:  TextStyle(fontSize:16,fontWeight:FontWeight.w500),),
                                  ],),
                                SizedBox(height: 4,),
                              ],),]
                            else...[
                              Column(children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    Text("${lang?.translate('Admin Charge')} ${widget.Data.adminCharge}%",style: TextStyle(fontSize: 11,color: Colors.grey),),
                                    Text("+ ${(double.parse(adminChargePer.toStringAsFixed(6)) * getController.currency.value).toStringAsFixed(6)} ${getController.currencyType.value}",style: TextStyle(fontSize: 14,fontWeight:FontWeight.w400),),
                                  ],),
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.end,
                                  children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    Text("${lang?.translate('Amount will debited')} :",style: TextStyle(fontSize:13,color: Colors.black87,fontWeight:FontWeight.w500),),
                                    // Text("${totalAmount} USD",style: TextStyle(fontSize:18,fontWeight:FontWeight.w500),),
                                    Text("${(double.parse(widget.Data.debitAmount) * getController.currency.value).toStringAsFixed(6)} ${getController.currencyType.value}",style:  TextStyle(fontSize:18,fontWeight:FontWeight.w500),),
                                  ],),
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.end,
                                  children: [
                                    Text("${widget.Data.debitAmount} USD",style: TextStyle(color: Colors.grey,fontSize: 11,fontWeight:FontWeight.w500),),
                                  ],),
                                SizedBox(height: 4,),
                              ],),
                            ]
                        ...
                        Row(children:  [
                          ...
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("${lang?.translate("Received")} \$${widget.Data.amount}",style: TextStyle(fontSize: 20),),
                                SizedBox(height: 2,),
                                Text(formattedDate,style: TextStyle(fontSize: 15,color: Colors.grey,),),
                                RichText(
                                  text: TextSpan(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("${lang?.translate("Received")} ${(double.parse(widget.Data.amount) * getController.currency.value).toStringAsFixed(6)} ${getController.currencyType.value}",style: TextStyle(fontSize: 20),),
                                SizedBox(height: 2,),
                                Text("\$${widget.Data.amount}",style: TextStyle(color: Colors.grey,fontSize: 13,fontWeight:FontWeight.w500),),
                                SizedBox(height: 2,),
                                Text(formattedDate,style: TextStyle(fontSize: 15,color: Colors.grey,),),
                                RichText(
                                  text: TextSpan(
