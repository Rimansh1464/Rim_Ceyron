...
class USuccessPage extends StatefulWidget {
  var transaction_id;
  var sender_name;
  var receiver_name;
  var Amount;
  ...
  @override
  State<USuccessPage> createState() => _USuccessPageState();
}

class _USuccessPageState extends State<USuccessPage> {
                        ...
                        Row(children:  [
                          ...
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("${lang?.translate('Paid')} ${(double.parse(widget.Amount) * getController.currency.value).toStringAsFixed(2)} ${getController.currencyType.value}",style: TextStyle(fontSize: 20),),
                                SizedBox(height: 2,),
                        ...
                        if(widget.Data.transactionType == "user_to_user")...[
                          ...
                          Column(children: [
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text("${lang?.translate('Admin Charge')} ${widget.Data.adminCharge}%",style: TextStyle(fontSize: 10,color: Colors.grey),),
                                Text("+ ${double.parse(adminChargePer.toStringAsFixed(6))} USD",style: TextStyle(fontSize: 12,fontWeight:FontWeight.w400),),
                              ],),
                            SizedBox(height: 6,),
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          ...
                          :Column(children: [
                            Row(
                              ...
                              children: [
                                Text("${widget.Data.receiverName.split(' ')[0]} ${lang?.translate('will get')}:",style: TextStyle(fontSize: 12,color: Colors.black87,fontWeight:FontWeight.w500),),
                                // Text("${initialAmount?.toInt()} USD",style: TextStyle(fontSize: 13,fontWeight:FontWeight.w400),),
                                Text("${(double.parse(widget.Data.amount) * getController.currency.value).toStringAsFixed(3)} ${getController.currencyType.value}",style: TextStyle(fontSize: 15,fontWeight:FontWeight.w500),),
                              ],),
                            Row(
                          ...
                          Column(children: [
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text("${lang?.translate('Agent Charge')} ${widget.Data.agentCharge}%",style: TextStyle(fontSize: 11,color: Colors.grey),),
                                Text("+ ${double.parse(agentChargePer.toStringAsFixed(6))} USD",style: TextStyle(fontSize: 13,fontWeight:FontWeight.w400),),
                              ],),
                            SizedBox(height: 6,),
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text("${lang?.translate('Amount will debited')} :",style: TextStyle(fontSize: 12,color: Colors.black87,fontWeight:FontWeight.w500),),
                                // Text("${totalAmount} USD",style: TextStyle(fontSize:18,fontWeight:FontWeight.w500),),
                                Text("${widget.Data.debitAmount} USD",style:  TextStyle(fontSize:15,fontWeight:FontWeight.w500),),
                              ],),
                            SizedBox(height: 4,),
                          ],):
                          Column(children: [
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text("${lang?.translate('Agent Charge')} ${widget.Data.agentCharge}%",style: TextStyle(fontSize: 10,color: Colors.grey),),
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.end,
                              children: [
                                Text("${double.parse(agentChargePer.toStringAsFixed(6))} USD",style: TextStyle(color: Colors.grey,fontSize: 10,fontWeight:FontWeight.w500),),
                              ],),
                            SizedBox(height: 6,),
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text("${lang?.translate('Amount will debited')} :",style: TextStyle(fontSize: 12,color: Colors.black87,fontWeight:FontWeight.w500),),
                                // Text("${totalAmount} USD",style: TextStyle(fontSize:18,fontWeight:FontWeight.w500),),
                                Text("${(double.parse(widget.Data.debitAmount) * getController.currency.value).toStringAsFixed(6)} ${getController.currencyType.value}",style:  TextStyle(fontSize:15,fontWeight:FontWeight.w500),),
                              ],),
                            Row(
                              mainAxisAlignment: MainAxisAlignment.end,
                              children: [
