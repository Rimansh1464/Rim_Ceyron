                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Lottie.asset("assets/lottie/otp.json",
                                  height: 160),
                              Text(
                                "${lang?.translate('OTP Verification')}",
                                style: TextStyle(
                                    fontSize: 25,
                                    color: Colors.black,
                              ...
                              AuP.userData!.email.isEmpty
                                  ...
                                  : Text(
                                      '${lang?.translate('Check your Email. We have Send you the at')} ${AuP.userData!.email}',
                                      textAlign: TextAlign.center,
                                      style: TextStyle(
                                        fontSize: 13,
                                        color: Colors.black,
...
//
                                      print("OTP::$OTP");
                                      if (authProvider.userData?.role ==
                                          'Agent') {
                                        authProvider.agentCheckOTP(
                                            OTP!, context);
                                      } else if (authProvider.userData?.role ==
                                          'User') {
                                        authProvider.userCheckOTP(
                                            OTP!, context);
                                      }
                                    },
                                    child: Container(
