...
class Signup_agent extends StatefulWidget {
  const Signup_agent({super.key});

  @override
  State<Signup_agent> createState() => _Signup_agentState();
}

class _Signup_agentState extends State<Signup_agent> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Authtextfeild(
                titletext: "${lang?.translate("Business Name")}",
                hintText: "${lang?.translate("Enter business name")}",
                controller: businessController,
                validator: (input) {
                  if (input == null || input.isEmpty) {
                    return '${lang?.translate("Please Enter Business Name")}';
                  }
                },
                icon: Icons.business),
            SizedBox(
            ...
            Authtextfeild(
                titletext: "${lang?.translate("Branch Name")}",
                hintText: "${lang?.translate("Enter branch name")}",
                controller: branchController,
                validator: (input) {
                  if (input == null || input.isEmpty) {
                    return '${lang?.translate("Please Enter Branch Name")}';
                  }
                },
                icon: Icons.cabin),
            SizedBox(
