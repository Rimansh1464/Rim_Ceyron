...
class VerifyPassport extends StatefulWidget {
  const VerifyPassport({super.key});

  @override
  State<VerifyPassport> createState() => _VerifyPassportState();
}

class _VerifyPassportState extends State<VerifyPassport> {
        ...
        child: SingleChildScrollView(
          child: Column(children: [
            ...
            Row(
              ...
              children: [
                Text("${lang?.translate("Let's Verify Your Passport")}",textAlign: TextAlign.center,style: TextStyle(fontSize: 24,fontWeight: FontWeight.w500,color: Colors.black),),
              ],
            ),
            SizedBox(height: 10,),
            Image.asset("assets/image/passport.png"),
            SizedBox(height: 20,),
            Row(
              ...
              children: [
                ...
                SizedBox(width: 5,),
                Flexible(child: Text(" ${lang?.translate('Chosen credential must not be expired.')}",style: TextStyle(fontSize: 15,fontWeight: FontWeight.w400,color: Colors.black),)),
              ],
            ),
            SizedBox(height: 15,),
            Row(
            ...
            InkWell(
              onTap: (){
                nextScreen(context, UploadDoc(color: mainColor,title: "${lang?.translate('Passport')}",image: 'assets/image/passport.png',));
              },
              child: Container(
                height: 55,
