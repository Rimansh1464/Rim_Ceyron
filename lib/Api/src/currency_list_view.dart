...
class CurrencyListView extends StatefulWidget {
  ...
  final ValueChanged<Currencys> onSelect;
...
class _CurrencyListViewState extends State<CurrencyListView> {
  ...
  late List<Currencys> _filteredList;
  late List<Currencys> _currencyList;
  List<Currencys>? _favoriteList;
  ...
  Widget _listRow(Currencys currency) {
  ...
  Widget _flagWidget(Currencys currency) {
  ...
  void _filterSearchResults(String query) {
    List<Currencys> searchResult = <Currencys>[];
